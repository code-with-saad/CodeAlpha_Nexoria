...
> For the full API endpoint reference see [API.md](API.md) (coming soon).

---

Part of a 3-project internship submission for CodeAlpha. See also: [Social Media Platform](#) (link coming soon)
